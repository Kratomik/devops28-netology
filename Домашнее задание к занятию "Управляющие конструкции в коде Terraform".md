...
- **Ответ:**
   ...
   ** В Вопросе, что задавал удалось разобраться** у меня проблема с ssh возникла из-за нехватки времени в ожидании на создание инстанса, пришлось увеличить время с 30 сек на 60 сек и все заработало :) Высылаю финальный код.
