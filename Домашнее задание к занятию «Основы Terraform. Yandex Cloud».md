...
Доавляю ссылку на код. Так как в задании 5-6 небыло требований приложени скриншотов, ответы на эти шаги в коде. В требование к приёму заданий так же небыло о том, что нужно прикладывать ссылку на код :), а только залить код в новую ветку terraform-02, что я и сделал.
